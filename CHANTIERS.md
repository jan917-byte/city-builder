...
| 10 | 🔄 ☐ **3 310 places de stationnement DE RUE, et aucune ne se voit** | 🔄 **Le titre a changé le 2026-08-19**, il disait « 4 587 places » et les deux moitiés ont bougé. La **place-parking est dessinée** : 123 places peintes sur les 127 que `04` annonce, écart **−3 %** → `Prototype/Toits et sol.md` § 3 nonies. Restent les **rues** : `routes.stationnement` en compte **3 310** (mesuré, l'ancien chiffre agrégeait les deux sens du champ — voir la dette ci-dessous). C'est toujours **le sujet du jeu** et la plus grosse chose que le sol ne dit pas. La forme à suivre est maintenant prouvée et pas seulement supposée : une trame tirée de la géométrie retombe à 3 % du compte du tableur. La place est **réservée dans l'image** — les mètres libres entre la bordure et l'asphalte |
...
- [ ] **`stationnement` porte deux sens** — part de surface sur l'îlot, places sur rue sur le tronçon — et « l'emprise voiture » agrège déjà les deux. **À renommer avant d'écrire la formule de l'indicateur**, sinon quelque chose les additionnera. 🔄 **Mesuré le 2026-08-19** : **3 310** places sur les tronçons, **1 028** sur les îlots (dont **127** sur la seule place-parking, les 901 autres sous des îlots bâtis, donc invisibles par construction). L'ancien chiffre unique de « 4 587 » ne correspond plus à aucune des deux colonnes — c'est exactement le symptôme que cette ligne annonce.
...
- [ ] **Les conséquences de 5 350 habitants** sur deux équipements : le lycée devient une Realschule et la barre de 1974 un petit Neubau. La galerie a disparu avec la décision 71. Acté dans la décision 13d, pas encore écrit dans `Ville/Wehrau.md`. 🔄 **La moitié « barre » est faite le 2026-08-19** : trois dalles de 46 à 58 m à 6 niveaux, 99 logements — reste le lycée, et reste à l'écrire dans le vault.
- [ ] **Le critère de réussite « 9 niveaux » est périmé** (`Plan 3 mois.md:48`, la touche `B` de la maquette). La barre est descendue à 6 le 2026-08-19 à la demande de l'auteur : soit le critère se réécrit, soit la baisse s'annule. **Ça ne se tranche pas dans une note de chantier** — `Questions ouvertes.md` **et** `Décisions arrêtées.md`. → `Prototype/Toits et sol.md` § 3 sexies
