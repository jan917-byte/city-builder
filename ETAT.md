...
**2026-08-31 (session 72).** Étape ouverte : **5 — [Le trafic visible](Prototype/Trafic.md)**, critère *une rue à `charge = 1,00` est désagréable à regarder* — **jamais jugé à l'écran**. L'étape 4 est en pause. 🎚️ **La fiche se règle avant de décider** : les cinq boutons qui partaient au clic sont devenus des réglages posés, la miniature a **deux boutons AVANT / APRÈS**, et un seul bouton engage tout en **un chantier**. Planter une rue est le sixième réglage. → [Trafic](Prototype/Trafic.md) § La fiche se règle
