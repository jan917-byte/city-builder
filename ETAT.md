...
- 🟠 **La miniature est passée en vue isométrique, et une rue s'y montre par son morceau le plus droit** — l'angle est celui du cube (35,26°), l'objet est vu de trois quarts, la fiche est sur papier, la dalle a une épaisseur, et **le cadre n'a plus de filet**. Une rue montre 39 m d'alignement avec ses voitures garées et roulantes ; survoler « Retirer les places » vide la bordure avant le clic. La fiche porte aussi **une barre de chantier** sous la miniature, absente hors travaux. À juger sur `--interface`, `wehrau_interface_chantier.png` compris. 🔴 **La berge reste le maillon faible** : montrée de près, elle flotte — ni Ilse, ni quai, ni sol autour, et ses deux rubans (quai et talus) se lisent comme deux fils. Lui donner son eau et son terrain ferait de la miniature un morceau de ville : **c'est un arbitrage, pas un réglage**.
