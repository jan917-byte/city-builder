...
- 🗺️ **La zone jouable reste plate**, hors chenal de l'Ilse (fond à −2,85 m, nappe à −2 m) et talus des 4 champs riverains. Le décor extérieur porte les montagnes de la vallée (demande de l'auteur, 2026-09-05) ; il ne change pas les altitudes de jeu.
...
- **Trois valeurs à t0 manquent** (la ville exposée, le CO₂, la desserte) et **`confort_ete` n'existe pas dans le `.gpkg`** — seule variable de D10, créée à 0. Et **chaque indicateur doit avoir un antagoniste** : les bornes sont la ceinture, le frein ce sont les antagonismes.
