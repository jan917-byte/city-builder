...
🧵 **La rive est une ligne, plus un feston** (2026-09-02, demandé devant l'image : « plus smooth, moins dentelé ; la frontière entre la berge et la route doit être une ligne »). Trois causes, toutes dans `07`. ① La bande de rive ondulait de **±28 % sur une sinusoïde de 9 m échantillonnée tous les 2 m** — une scie. Sa largeur est désormais **constante (3,5 m)**, rabotée par ce que la chaussée laisse, moyennée sur 8 m et biseautée à 0,25 m par station : le bord côté ville est droit, et le ruban de sélection avec lui. Le talus, lui, garde une ondulation — **±14 % sur 29 et 61 m**, quinze stations par vague. ② 🔴 **Le mètre de la rive droite manquait une station sur quatre** : `G` remet l'altitude à plat au-dessus de l'eau, et la coupe qui en décide est calculée tous les 25 cm — un sommet de la ligne de berge tombait du côté mouillé, et le mur, la bande et le haut du talus **plongeaient d'un mètre sous la ville**. C'est par ces trous qu'on voyait la route sous l'herbe (`_cale_rive` ; le pied du mur, lui, reste dans le lit). ③ La promenade de quai s'arrêtait au nu de la bande, or l'une suit la RUE et l'autre la BERGE : elle glisse maintenant **1 m dessous**. ✅ **Le contrôle du clic de `--essai` passe** (`b 6`) — il tombait à côté depuis que la bande était enterrée. **Ce qui prouverait que c'est cassé** : une dent dans le bord vert, un coin gris entre la bande et la promenade, un roseau au-dessus du fleuve, un pied de mur qui ne descend plus dans l'eau.
