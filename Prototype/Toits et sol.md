...
| **L'échange** — `wehrau_essai_materiaux.png` (toits rouges sur murs clairs) contre `wehrau_essai_diag_tissu.png` (thème « tissu ») | **si la seconde te manque tout le temps, la lecture par époque ne suffit pas et il faut rediscuter.** C'est le seul vrai risque de la passe |
