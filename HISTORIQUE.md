...
**2026-08-21 (session 50) — la crue revient, sur une branche.** Branche `crue`, reprise de la décision **23b** suspendue depuis le 2026-08-12. Un maillon de chaîne, `04e_crue.py`, met la **hauteur d'eau en mètres** au centre — l'essai abandonné cherchait une portée, qui n'est qu'une distance déguisée et redonnait la carte de l'altitude. Deux pentes de sol et un décrochement de terrasse suffisent à faire ce que 23b décrit : **18 ruines et 100 sinistrés en rive gauche, zéro en face**, 369 des 417 logements du faubourg. L'`alea` moyen retombe à **0,77** contre 0,75 annoncé au vault, sans avoir été calé dessus.
À l'écran : les ruines perdent toit et étages, le limon salit rues, jardins et sols du faubourg, et le **pont 168 est emporté** — la chaussée s'arrête net des deux rives, sans tablier. Deux points de vue, `F` et `N`. 🔴 Le rendu s'obtient **sans ouvrir `_bord_eau`** : on ampute l'axe du pont une fois, et les cinq recettes qui le lisent n'y voient plus d'ouvrage. La dalle d'une ruine a dû être **éclaircie** — sombre, elle se lisait comme un hangar, et Wehrau en a déjà deux.
🐞 **Le contrôle de l'asphalte en l'air mesurait une chaussée qui n'existe plus** : il rebâtissait l'axe depuis `routes` au lieu de lire ce qui est émis, et annonçait 296 m² au-dessus du vide là où il n'y a plus de pont du tout. Corrigé — il reçoit désormais les morceaux réellement émis, et repasse à 100 % porté. *Un contrôle qui mesure autre chose que ce qu'on affiche est pire qu'absent.*
⚠️ Le choix du joueur n'est pas écrit : les prix des trois postures sont du level design, et deux arbitrages bloquent — la rive droite risque-t-elle quelque chose (0,02 mesuré contre 0,43 au vault), et quel pont on coupe (168 contredit 30c).
